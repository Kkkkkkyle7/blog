...
const config: SiteConfig = {
  ...
  site: 'https://blog-virid-five-16.vercel.app',
  ...
  navLinks: [
    {
      name: uiText.nav.home,
      url: '/',
    },
    {
      name: uiText.nav.archive,
      url: '/posts',
    },
    {
      name: uiText.nav.about,
      url: '/about',
    },
    {
      name: uiText.nav.github,
      url: 'https://github.com/Kkkkkkyle7/blog',
      external: true,
    },
  ],
